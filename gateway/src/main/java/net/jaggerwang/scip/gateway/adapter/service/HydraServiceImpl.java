...
import net.jaggerwang.scip.common.adapter.service.AsyncService;
import net.jaggerwang.scip.gateway.usecase.port.service.HydraService;
import net.jaggerwang.scip.gateway.usecase.port.service.dto.auth.*;
...
@Component
public class HydraServiceImpl extends AsyncService implements HydraService {
    protected ObjectMapper objectMapper;

    public HydraServiceImpl(@Qualifier("hydraServiceWebClient") WebClient webClient,
