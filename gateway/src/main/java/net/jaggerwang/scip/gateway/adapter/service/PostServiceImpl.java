...
@Component
public class PostServiceImpl extends AsyncInternalService implements PostService {
    protected ObjectMapper objectMapper;

    public PostServiceImpl(@Qualifier("postServiceWebClient") WebClient webClient,
