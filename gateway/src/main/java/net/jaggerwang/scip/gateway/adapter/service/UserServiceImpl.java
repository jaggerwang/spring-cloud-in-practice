...
@Component
public class UserServiceImpl extends AsyncInternalService implements UserService {
    protected ObjectMapper objectMapper;

    public UserServiceImpl(@Qualifier("userServiceWebClient") WebClient webClient,
