...
CREATE USER 'scip_auth'@'%' IDENTIFIED BY '123456';
GRANT ALL PRIVILEGES ON `scip_auth`.* TO 'scip_auth'@'%';
...
CREATE USER 'scip_hydra'@'%' IDENTIFIED BY '123456';
GRANT ALL PRIVILEGES ON `scip_hydra`.* TO 'scip_hydra'@'%';