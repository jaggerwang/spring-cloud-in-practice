...
public abstract class AsyncInternalService extends AsyncService {
    public AsyncInternalService(WebClient webClient, ReactiveCircuitBreakerFactory cbFactory) {
